                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg bg-gray-800 border-dark"
                                    id="name" aria-describedby="emailHelp" name="name"required autofocus
                                    autocomplete="name">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a id="loginLink" href="{{ route('login') }}" class="form-text ms-5 mb-4">Already have an account ?</a>
                            </div>
                        </div>
                    </form>

        ...
        @if (session('status') === 'ticketSubmitted')
            <div class="text-center container px-vw-5 py-vh-5">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <a href="{{ route('front.ticket.myTickets') }}" class="btn btn-light btn-xl mb-4 rounded-pill">My
                        tickets</a>
                </div>
            </div>
        ...
        @else
            <div class="container px-vw-5 py-vh-5">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <form action="{{ route('front.ticket.store') }}" method="POST" class="w-100"
                        style="max-width: 600px;" id="ticketForm">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('front.ticket.myTickets') }}"
                                class="btn btn-outline-light btn-xl rounded-pill">My
                                tickets</a>

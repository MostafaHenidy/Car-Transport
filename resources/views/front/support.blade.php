        ...
        <div class="container px-vw-5 py-vh-5">
            ...
            <div class="text-center mb-5">
                <div class="progress mx-auto" style="width: 60%;">
                    <div id="progressBar" class="progress-bar text-light text-bg-secondary" style="width: 25%">
                        Login
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-center align-items-center">
                <form action="{{ route('front.ticket.store') }}" method="POST" class="w-100" style="max-width: 600px;">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="subject" class="form-control form-control-lg bg-gray-800 border-dark text-secondary"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-floating">
                            <textarea name="message" class="form-control" style="height: 100px" required></textarea>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mt-3 float-end">
                        <button type="submit" class="btn btn-light btn-xl mb-4 rounded-pill">Submit</button>
                    </div>
                    <div class="d-flex align-items-center mt-3 float-start">
                        <a href="{{ route('front.ticket.myTickets') }}" class="btn btn-outline-light btn-xl mb-4 rounded-pill">My
                            tickets</a>
                    </div>
                </form>
            </div>
